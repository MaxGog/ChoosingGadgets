...
{
private:
	string OS, type, model; string typeCPU = "x64";
...
public:
	...
	void view(int profile)
	{
		...
		if (profile == 2)
		{
			...
			cout << "Разрядность процессора: " << typeCPU << endl;
		...
		if (!file.is_open())
		{
			cout << "Ошибка открытия файла. Данная рекомендация в файл не будет записана! Код ошибки: 0х0004 . . ." << endl;
		}
		else
		{
			...
			file << "Разрядность процессора: " << typeCPU << endl;
