...
namespace PC_support.Views
{
    public sealed partial class ModelsPage : Page
    {
        ...
        private void SelectPage_ItemClick(object sender, ItemClickEventArgs e)
        {
            ...
            ListModel selectedModels = (ListModel)e.ClickedItem;
            if (selectedModels == MacBook_Air)
            {
                image.Source = new BitmapImage(new Uri("ms-appx:///Assets/Resources/MacBook_Air.png"));
            ...
            {
                image.Source = new BitmapImage(new Uri("ms-appx:///Assets/Resources/Surface.png"));
